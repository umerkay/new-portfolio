...
export default function Signature() {
	return (
		<div id="cover">
			<div id="signature">
				<div>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 360">
						<defs>
							<svg width="0" height="0">
								<defs>
									<linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="100%">
										{/* <stop offset="0%" style={{ stopColor: "#498ff7", stopOpacity: 1 }} /> */}
										{/* <stop offset="9%" style={{ stopColor: "#c738c3", stopOpacity: 1 }} /> */}
										<stop offset="20%" style={{ stopColor: "#ea4646", stopOpacity: 1 }} />
										{/* <stop offset="24%" style={{ stopColor: "#ea4646", stopOpacity: 1 }} /> */}
										{/* <stop offset="35%" style={{ stopColor: "#c738c3", stopOpacity: 1 }} /> */}
										<stop offset="44%" style={{ stopColor: "#498ff7", stopOpacity: 1 }} />
										{/* <stop offset="50%" style={{ stopColor: "#c738c3", stopOpacity: 1 }} /> */}
										{/* <stop offset="56%" style={{ stopColor: "#ea4646", stopOpacity: 1 }} /> */}
