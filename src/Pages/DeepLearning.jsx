...
export default function DeepLearning() {
    return (<>
        ...
        <h1 id='DL' className="title"> Deep Learning & ML Projects</h1>
        {/* <h3 style={{color: "#eee", fontStyle: "italic"}}>Demos not available due to resource constraints.</h3> */}
        {/* <div className='spacer' /> */}
        {/* <div className='spacer' /> */}
        <Display
            title="AgroData: Large-scale Early/In-Season Crop Type Mapping Framework for Pakistan"
            subtitle="Final Year Project at NUST, SEECS"
            links={[
                // { href: "#", text: "Report", style: { backgroundColor: 'rgb(0, 123, 255)', color: 'white' } },
                { href: "/fypposter.pdf", text: "Poster", style: { backgroundColor: 'rgb(255, 193, 7)', color: 'black' } },
                { href: "https://cropmapping-platform.vercel.app/", text: "Live", style: { backgroundColor: 'rgb(40, 167, 69)', color: 'white' } },
            ]}
            images={[img6]}
            description="⭕ A comprehensive framework for mapping crop types across Pakistan using satellite imagery and machine learning techniques. This final year project at NUST SEECS demonstrates large-scale agricultural monitoring capabilities."
            // info={<span><br /><b>Developed as part of Final Year Project at National University of Sciences and Technology (NUST), School of Electrical Engineering and Computer Science (SEECS)</b></span>}
            titleStyle={{ fontSize: '2.2em' }}
            logoAlt="Crop Type Mapping Framework"
            id={"cropMapping"}
            // imgHorizontal={true}
