    ...
    <div className="container anim fadein">
      <div className="about">
        ...
        <AboutSection
          ...
          desc={"I will (soon) be making videos explaining deep learning and AI concepts over on youtube. 3blue1brown, Computerphile, Tom Scott and Yannic Kilcher are some of my inspirations. Work in Progress 🚧👷"}
          img={img1}
          dir='right'
        ></AboutSection>
